...
// --- Deklarasi model SESUAI modul: letakkan SETELAH MainActivity ---
data class Student(
    var name: String
)
...
@Composable
fun Home() {
    // state objek Student untuk input user
    var student by remember { mutableStateOf(Student("")) }

    // state list yang bisa berubah
...
// UI stateless (seperti di modul: state di-hoist)
@Composable
fun HomeContent(
    student: Student,
